...
/*
 * Modifications:
 * -Imported from iosched com.google.android.apps.iosched.util
 * https://code.google.com/p/iosched/source/browse/android/src/main/java/com/google/android/apps/iosched/util/Lists.java
...
public class Lists {
     ...
     * 
     * <p>
     * where {@code sub1} and {@code sub2} are references to subtypes of {@code Base}, not of {@code Base} itself. To get around
     * this, you must use:
     * 
     * <p>
